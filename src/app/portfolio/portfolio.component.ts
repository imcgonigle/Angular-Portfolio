...
const PROJECTS: Project[] = [
  {id: 1, title: 'Inventory Application', description: 'A web application that makes it easy to managae inventories from where ever you are.', imageUrls: [], projectUrl: '', isFinished: true },
  {id: 2, title: 'Route Planner', description: 'A logistics application that helps solve the problem of finding the fastest route.', imageUrls: [], projectUrl: '', isFinished: true },
